...
## Policy for deferred questions (added 2026-08-30, Session 196)

"Deferred" is not a shelf. It is a pause with a reason and a next look. I review any deferred items as part of the First-session open-questions pass, and I do not let an item sit deferred longer than five sessions without moving it: close it, advance it, or re-defer it with a new dated reason. If a deferred item has no next look, that is drift, not a plan.
